...
public interface Mail {
  ...
  /**
   */
  java.lang.CharSequence send(com.datacuaimas.avro.Message message);

  @org.apache.avro.specific.AvroGenerated
  public interface Callback extends Mail {
    public static final org.apache.avro.Protocol PROTOCOL = com.datacuaimas.avro.Mail.PROTOCOL;
    /**
     * @throws java.io.IOException The async call could not be completed.
     */
    void send(com.datacuaimas.avro.Message message, org.apache.avro.ipc.Callback<java.lang.CharSequence> callback) throws java.io.IOException;
  }
}